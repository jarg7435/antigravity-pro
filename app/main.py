...
# LAGEMA JARG74 - VERSION 6.40.0 - PRESS INTELLIGENCE RELEASE
SECRET_CODE = "1234"
...
# Initialize Services
@st.cache_resource
def get_services(version: str = "6.40.0 (Press Intelligence)"):
...
if not available_teams and selected_league != "Liga Extra (Manual)":
    ...
    if home_team and away_team:
        ...
        with st.sidebar.expander("🛠️ INFO DE VERSIÓN"):
            st.markdown(f"**App Version:** 6.40.0 (Press Intelligence)")
